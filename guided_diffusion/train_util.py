    ...
    def run_loop(self):
        ...
        while (
            ...
            if self.step % self.log_interval == 0  and self.timing_count > 0:
                ...
                logger.log(f"[Timing] avg data_time: {avg_data_time:.4f}s")
                logger.log(f"[Timing] avg step_time: {avg_step_time:.4f}s")
                logger.log(f"[Timing] avg fb_time:   {avg_fb_time:.4f}s")
                logger.log(f"[Timing] avg opt_time:  {avg_opt_time:.4f}s")
