"""
【方案1改进版】Training Script for Scheme 1

使用全新的script_util_scheme1和train_util_scheme

启动命令：
  python scripts/segmentation_train_scheme1_new.py \
      --data_dir ./data/mydata \
      --batch_size 8 \
      --lr 3e-5 \
      --out_dir ./results/train/mydata_scheme1_new
"""
...
from guided_diffusion_old.mydataloader_scheme1 import MyDatasetScheme1
...
def main():
    """Main training function for Scheme 1"""
    ...
    logger.log("=" * 80)
    logger.log("SCHEME 1 TRAINING - 缩放原图到256×256版本")
    logger.log("=" * 80)
    ...
    logger.log("\nLoading dataset...")
    ds = MyDatasetScheme1(args, args.data_dir, mode='training')
...
def create_argparser():
    """Create argument parser for Scheme 1"""
    defaults = dict(
        data_name="mydata",
        data_dir="./data/mydata",
